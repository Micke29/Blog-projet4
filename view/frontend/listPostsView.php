...
<!-- Blog entry -->
  <div class="w3-card-4 w3-margin w3-white">
    ...
    <div class="w3-container">
      ...
      <p class="w3-right"><a href="index.php?action=post&id=<?= $post['pst_id'] ?>#commentArea"><button class="w3-button w3-black"><b>Commentaire(s)&nbsp;</b><span class="w3-tag w3-white"><?= $post['cmt_number'] ?></button></a></span></p>
      <p class="w3-clear"></p>
    </div>
  </div>
  <hr>
